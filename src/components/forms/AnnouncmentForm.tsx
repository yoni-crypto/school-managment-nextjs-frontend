...
const schema = z.object({
    username: z.string().min(3, { message: 'Username must be at least 3 character long!' }).max(20, { message: 'Username must not exceed 20 characters!' }),
...
const AnnouncmentForm = ({ type, data }: { type: "create" | "update"; data?: any }) => {
    ...
    return (
        <form className='flex flex-col gap-8' onSubmit={onSubmit}>
            <h1 className='text-xl font-semibold'>Create a new Announcment</h1>
