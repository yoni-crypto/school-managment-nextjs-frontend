    ...
    const renderRow = (item: Announcment) => (
        <tr key={item.id} className='border-b border-gray-200 even:bg-yoPurpleLight'>
            ...
            <td className=''>
                ...
                {role === "admin" && (
                        <>
                            <FormModel table="announcment" type="update" data={item} />
                            <FormModel table="announcment" type="delete" id={item.id} />
                        </> 
                    )}
                </div>
            </td>
            ...
            <div className='flex items-center justify-between'>
                ...
                <div className='flex flex-col md:flex-row items-center gap-4 w-full md:w-auto'>
                    ...
                    <div className='flex items-center gap-4 self-end'>
                        ...
                        {role === "admin" && (
                            <FormModel table="announcment" type="create"/>
                        )}
                    </div>
                </div>
            </div>
...
export default AnnouncmentsListPage
