...
const getDayOffset = (offset: number, hours: number, minutes: number) => {
  ...
  const weeklySchedule = [
    { title: "Math", time: [8, 0], duration: 45 },
    { title: "English", time: [9, 0], duration: 45 },
    { title: "Biology", time: [10, 0], duration: 45 },
    { title: "Physics", time: [12, 0], duration: 45 },
    { title: "Chemistry", time: [13, 0], duration: 45 },
    { title: "History", time: [15, 0], duration: 45 },
    { title: "Amharic", time: [16, 0], duration: 45 },
  ];

  const generateDailySchedule = (dayOffset: number) => {
    return weeklySchedule.map(({ title, time, duration }) => ({
      title,
      allDay: false,
      start: getDayOffset(dayOffset, time[0], time[1]),
      end: getDayOffset(dayOffset, time[0], time[1] + duration),
    }));
  };
...
export const calendarEvents = [
    ...generateDailySchedule(-5),
    ...generateDailySchedule(-4),
    ...generateDailySchedule(-3),
    ...generateDailySchedule(-2),
    ...generateDailySchedule(-1), // Yesterday
    ...generateDailySchedule(0), // Today
    ...generateDailySchedule(1), // Tomorrow
    ...generateDailySchedule(2),
    ...generateDailySchedule(3),
    ...generateDailySchedule(4),
    ...generateDailySchedule(5),
    ...generateDailySchedule(6),
    ...generateDailySchedule(7), // One week later
  ];